...
def main():
    ...
    with st.form(key='Form1'):
        with st.sidebar:
            ...
            raeume = st.sidebar.slider("Anzahl Räume:", 1, 12, 4, 0.5)
    ...
    try:
        ...
        fig2.update_layout(title={"text":"Durchschnittsmieten (kalt) je qm","y":0.92},barmode="stack", xaxis={"categoryorder": "total ascending"})
